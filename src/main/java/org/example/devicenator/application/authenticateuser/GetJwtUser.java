...
public class GetJwtUser implements UserDetailsService {
    ...
    @Autowired
    public GetJwtUser(UserRepository userRepository, JwtToken jwtToken) {
    ...
    public String token(String rawEmail) throws UserException {
